    ...
    <div className="max-w-2xl mx-auto p-8 bg-white shadow-xl rounded-lg border border-gray-200">
          ...
          {decryptedPassword && (
            <div className="mt-4 p-4 bg-green-50 rounded-md border border-green-200">
              ...
              <div className="relative">
                ...
                <button
                  onClick={handleCopy}
                  className="absolute top-2 right-2 text-green-700 text-xs bg-green-100 px-2 py-1 rounded hover:bg-green-200 transition"
                >
                  {copied ? "✅ Copied!" : "📋 Copy"}
                </button>
              </div>
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div className="mt-4 text-sm text-gray-500">
          Note: Decryption happens locally in your browser. Your private key and
